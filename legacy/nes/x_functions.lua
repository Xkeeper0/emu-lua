...
if not memory.writeword then
	memory.writeword	= function(address, value)
		memory.writebyte(address + 1, math.floor(value / 0x100));
		memory.writebyte(address    , math.fmod (value,  0x100));
--		gui.text(100, 100, "OK");
	end;
end;
