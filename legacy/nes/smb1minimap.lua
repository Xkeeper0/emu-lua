...
function smbram2px(offset)
	...
	px			= (math.fmod(offset, 0x10) + math.floor(offset / 0x100) * 0x10) * 0x10;
...
--[[	
	...
	for i = 0, 2 do
		balls[z]	= {x = math.random(0, 512), y = 0, xs = math.random(-50, 10) / 100, ys =  math.random(10, 150) / 100, life = math.random(400, 700), c = math.random(200, 255)};
		z			= z + 1;
	end;
