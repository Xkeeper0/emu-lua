	...
	while true do
		...
		local cameraPos		= getPosition(0xc320, 0xc322)
		gui.text(12, 116, string.format("%02x00 %02x00", memory.readbyte(0xc329), memory.readbyte(0xc32a)))
		gui.text(12, 123, string.format("%02x00 %02x00", memory.readbyte(0xc32b), memory.readbyte(0xc32c)))
		...
		for i = 0, 0x1F do
			local mX, mY		= 0xd00c + 0x40 * i, 0xd00e + 0x40 * i
